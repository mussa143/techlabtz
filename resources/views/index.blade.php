...
<body style='background-image:url({{url('img/backg.jpg')}})'>
  <div class="wrapper ">
    <div class="sidebar" data-color="azure" data-background-color="transparent">
      <!--
  ...
  -->
      ...
      <div class="sidebar-wrapper" style="background-color:#000">
      <br><br><br>
         <h2 style="height:20%;text-align:center;color:green;">DATE: {{ date('Y-m-d H:i:s') }}</h2>
      </div>
    </div>
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            </script>, made with <i> passion</i> by
            <a href="https://www.techlabtz.com" target="_blank">Techlabtz</a>.
          </div>
          <!-- your footer here -->
        </div>
      </footer>
